#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade HG on Sat Jul  9 20:58:11 2011
...
class ConfigFrame(wx.MDIChildFrame):
    def __init__(self, *args, **kwds):
        ...
        self.bg_choice = wx.ComboBox(self.panel_2, -1, choices=[], style=wx.CB_DROPDOWN)
        ...
        self.Bind(wx.EVT_COMBOBOX, self.h_choice_changed, self.bg_choice)
        self.Bind(wx.EVT_BUTTON, self.h_save_pressed, self.bg_save)
        self.Bind(wx.EVT_TEXT_ENTER, self.h_text_enter, self.bg_config)
    ...
    def __do_layout(self):
        ...
        sizer_7.Add(self.bg_config_status, 0, 0, 0)
...
class MyFrame3(wx.MDIChildFrame):
    def __init__(self, *args, **kwds):
