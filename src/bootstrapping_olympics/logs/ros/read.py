...
class ROS2Python():
    ...
    def __init__(self, spec, id_robot, max_dt=1):
        self.last = None
        self.spec = spec
        self.max_dt = max_dt
        
        self.keeper = ObsKeeper(spec, id_robot)
    ...
    def convert(self, ros_obs, filter_doubles=True):
        ...
        try:
            ...
            self.spec.check_compatible_raw_sensels_values(ros_obs.sensel_values)
        ...
        obs.sensel_values = self.spec.reshape_raw_sensels(ros_obs.sensel_values)
