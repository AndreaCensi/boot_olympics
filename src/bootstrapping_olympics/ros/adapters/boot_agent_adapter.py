...
from bootstrapping_olympics.logs.ros import (ROS2Python,
    boot_spec_from_ros_message)
...
from bootstrapping_olympics.ros.ros_script_utils.rospy_logger import RospyLogger
...
class BootAgentAdapter():
    ...
    def __init__(self, data_central, id_agent, agent, publish_interval):
        ...
        self.set_commands = rospy.ServiceProxy('commands', BootstrappingCommands) #@UndefinedVariable
...
def read_one_observation(sleep=0.1):
    ...
    # Subscribe to the observations
    subscriber = rospy.Subscriber('observations', BootstrappingObservations, #@UndefinedVariable
                     handle_observations)
