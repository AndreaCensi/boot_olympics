...
htmlhelp_basename = 'boot_olympics_doc'
...
latex_documents = [
  ('index', 'boot_olympics.tex', u'BootOlympics Documentation',
...
man_pages = [
    ('index', 'boot_olympics', u'BootOlympics Documentation',
     [u'Andrea Censi'], 1)
]
